...
//   protoc               unknown
// source: int3face/tokenfactory/v1beta1/genesis.proto
...
export const GenesisDenom: MessageFns<GenesisDenom> = {
  encode(message: GenesisDenom, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.denom !== "") {
      writer.uint32(10).string(message.denom);
    }
    if (message.authorityMetadata !== undefined) {
      DenomAuthorityMetadata.encode(message.authorityMetadata, writer.uint32(18).fork()).join();
    }
    return writer;
  },
